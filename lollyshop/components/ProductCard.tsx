...
import { ShoppingBag, ShoppingCart, Star, Zap, Flame, CheckCircle2, Heart } from 'lucide-react';
...
export default function ProductCard({ product }: { product: any }) {
    ...
    return (
        <div
            className="bg-white flex flex-col h-full hover:shadow-lg transition-all duration-300 rounded-lg overflow-hidden border border-gray-200/60 relative group cursor-pointer"
            onClick={() => {
                trackView();
        ...
        >
            ...
            <div className="relative aspect-square overflow-hidden bg-white group/card-img">
                <div className="absolute inset-0 bg-gray-50/50 group-hover/card-img:bg-gray-100/50 transition-colors duration-500" />
                ...
                {product.image ? (
                    <div className="relative w-full h-full p-4 sm:p-6">
                        <Image
                            ...
                            alt={product.name}
                            fill
                            className="object-contain p-4 sm:p-6 transition-all duration-700 group-hover/card-img:scale-110 group-hover/card-img:rotate-1"
                        />
                    </div>
                ) : (
