                            ...
                            <form onSubmit={handleSubmit} className="px-6 sm:px-10 py-6 space-y-6 overflow-y-auto custom-scrollbar smooth-scroll flex-1 overflow-x-hidden">
                                ...
                                <div className={`space-y-6 animate-in fade-in slide-in-from-left-2 duration-300 ${activeTab !== 'info' ? 'hidden' : ''}`}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input name="name" ref={nameRef} required className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-base font-bold focus:border-shop/50 outline-none transition-all text-white placeholder:text-muted-foreground/20 shadow-inner" placeholder="Ex: Chemise Silk Premium" />
                                    </div>
