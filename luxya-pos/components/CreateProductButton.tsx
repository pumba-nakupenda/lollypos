            ...
            {isOpen && (
                <Portal>
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 sm:p-4 backdrop-blur-md bg-background/40">
                        <div role="dialog" aria-modal="true" className="glass-panel w-full max-w-xl lg:max-w-3xl rounded-[24px] sm:rounded-[32px] shadow-2xl border-white/10 animate-in zoom-in-95 duration-200 max-h-[92vh] flex flex-col overflow-hidden">
                            {/* Modal Header */}
