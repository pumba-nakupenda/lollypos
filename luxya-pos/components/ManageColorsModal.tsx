...
export default function ManageColorsModal({ isOpen, onClose, colors, shopId, onRefresh }: ManageColorsModalProps) {
        ...
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 backdrop-blur-xl bg-black/40">
            <div className="relative glass-card w-full max-w-md p-8 rounded-[40px] shadow-2xl border-white/10 animate-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center space-x-3 mb-8">
                    ...
                    <h2 className="text-xl font-black uppercase tracking-tight">Gérer les Couleurs</h2>
                </div>
                                ...
                                {editingColor === color ? (
                                    ...
                                    <>
                                        <div className="flex items-center space-x-3">
                                            <div className="w-4 h-4 rounded-full border border-white/20 shadow-lg" style={{ backgroundColor: color.toLowerCase() }} />
                ...
                <div className="mt-8 pt-6 border-t border-white/5 text-center">
                    <p className="text-[8px] font-black uppercase text-muted-foreground tracking-widest">
                        Toute modification sera appliquée aux variantes du site web et du POS.
                    </p>
                </div>
            </div>
        </div>
